...
rtd266x_flash -i 2 -r 1024 out.bin

Write all bytes from file in.bin:
rtd266x_flash -w in.bin''', formatter_class = RawTextHelpFormatter)
...
if (args.read == None and args.write_diff == None and args.write == False):
	parser.print_help()
	sys.exit(1)
