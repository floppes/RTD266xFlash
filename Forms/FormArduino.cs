...
namespace RTD266xFlash.Forms
{
    public partial class FormArduino : Form
    {
        ...
        {
            numericBaudRate.Hexadecimal = !radioButton2.Checked;
            numericReadLength.Hexadecimal = !radioButton2.Checked;
            numericReadStartAddress.Hexadecimal = !radioButton2.Checked;
            numericWriteStartAddress.Hexadecimal = !radioButton2.Checked;
        }
    }
}
